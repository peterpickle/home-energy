...
read_fields = [
    ...
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Monday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Tuesday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Wednesday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Thursday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Friday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Saturday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1Timer_Sunday', RETURN_TYPE.RANGE, 0],
    ...
    [VRC700_CIRCUIT_NAME, 'Hc1ActualFlowTempDesired', RETURN_TYPE.ANY, 30],
    ...
    [VRC700_CIRCUIT_NAME, 'AdaptHeatCurve', RETURN_TYPE.ANY, 0],

    # Cooling Circuit
    [VRC700_CIRCUIT_NAME, 'ManualCooling', RETURN_TYPE.ANY, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTemp', RETURN_TYPE.ANY, 0],
    [VRC700_CIRCUIT_NAME, 'OpModeCooling', RETURN_TYPE.ANY, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Monday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Tuesday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Wednesday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Thursday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Friday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Saturday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'Z1CoolingTimer_Sunday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'RoomHumidity', RETURN_TYPE.ANY, 0],
    ...
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Monday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Tuesday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Wednesday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Thursday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Friday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Saturday', RETURN_TYPE.RANGE, 0],
    [VRC700_CIRCUIT_NAME, 'HwcTimer_Sunday', RETURN_TYPE.RANGE, 0],
]
